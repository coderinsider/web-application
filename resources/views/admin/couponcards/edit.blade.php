...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item active" aria-current="page"><a href="/admin/couponcards/edit/{{$id}}"><i class="fas fa-chevron-right"></i><h4>Create Edit</h4></a></li>
</ol>
@endsection
@section('content')
    <div class="markappwrapper">
        ...
        <div class="markappboxing">
            ...
            <form id="createnow" action="{{ route('couponcardseditcreate', ['id' => $id]) }}" method="post">
                <div class="markappbody">
                    <div class="userformdata">
                        <div class="form-group custom-form-group">
                            <label for="name">Coupon Code <span style="color:red;">*</span></label>
                            <input type="text" class="form-control"  name="coupon_code" value="{{$coupon_code}}" old="coupon_code" placeholder="Enter Code"/>
                        </div>

                        <div class="form-group custom-form-group">
                            <label for="email">Coupon Prices <span style="color:red;">*</span></label>
                            <input type="email" class="form-control" name="coupon_price" value="{{ $coupon_price }}" old="coupon_price" placeholder="Enter Coupon Price" />
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Coupon Record</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="asktouser">
                                            <p>Are you sure want to update record?</p>
                                        </div>
                                    </div>
