...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item"><a href="/admin/product-sec-category"><i class="fas fa-chevron-right"></i><h4>Second Product Category</h4></a></li>
    <li class="bread-item active" aria-current="page"><a href="/admin/product-sec-category/new"><i class="fas fa-chevron-right"></i><h4>Category New</h4></a></li>
</ol>
@endsection
@section('content')
    <div class="markappwrapper">
        ...
        <div class="markappboxing">
            ...
            <form id="createnow" action="{{ route('productseccategorynewcreate') }}" method="post">
                ...
                <div class="markappbody">
                    <div class="userformdata">
                        ...
                        <div class="form-group custom-form-group">
                            <label for="email">Second Category <span style="color:red;">*</span></label>
                            <input type="text"  class="form-control" name="sec_category_name" placeholder="Second Category"/>
                        </div>
                    </div>
                </div>
            </form>
