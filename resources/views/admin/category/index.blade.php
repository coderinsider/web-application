...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item active" aria-current="page"><a href="/admin/productcategory"><i class="fas fa-chevron-right"></i><h4>Category Lists</h4></a></li>
</ol>
@endsection
@section('content')
<div class="backend-right-main-panel">
    ...
    <div class="backend-head-box">
        ...
        <div class="nav-post-add">
            <a href="{{ route('productcategorynew') }}">Add New</a>
        </div>
    </div>
        ...
        <div class="table-box-panel">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>{{ $eachValue->category_name }}</td>
                    <td>{{ $eachValue->category_des }}</td>
                    <td>
                        <div class="moreactions">
                            <div class="editme">
                                <button><a href="{{ route('productcategoryedit', ['id' => $eachValue->id])}}"><i class="fas fa-edit"></i> Edit</a></button>  
                            </div>
                            <div class="deleteme"> 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="deletenow{{$eachValue->id}}" method="post" action="{{ route('productcategorydelete', ['id' => $eachValue->id])}}"></form>
                                            </div>
                                        </div>
                                    </div>
                                </div>                                  
