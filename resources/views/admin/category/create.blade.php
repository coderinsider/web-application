...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item active" aria-current="page"><a href="/admin/productcategory/new"><i class="fas fa-chevron-right"></i><h4>Category New</h4></a></li>
</ol>
@endsection
@section('content')
    <div class="markappwrapper">
        ...
        <div class="markappboxing">
            ...
            <form id="createnow" action="{{ route('productcategorynewcreate') }}" method="post">
