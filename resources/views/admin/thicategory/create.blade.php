...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item"><a href="/admin/product-thi-category"><i class="fas fa-chevron-right"></i><h4>Third Product Category</h4></a></li>
    <li class="bread-item active" aria-current="page"><a href="/admin/product-thi-category/new"><i class="fas fa-chevron-right"></i><h4>Category New</h4></a></li>
</ol>
@endsection
@section('content')
    <div class="markappwrapper">
        ...
        <div class="markappboxing">
            ...
            <form id="createnow" action="{{ route('productthicategorynewcreate') }}" method="post">
                ...
                <div class="markappbody">
                    <div class="userformdata">
                        <div class="form-group custom-form-group">
                            <label for="name">First Category <span style="color:red;">*</span></label>
                        ...
                        <div class="form-group custom-form-group">
                            ...
                            <select class="form-control" name="sec_category_id">
                                @foreach($second_cate as $cate)
                                <option value="{{ $cate->id }}">{{ $cate->sec_category_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group custom-form-group">
                            <label for="email">Third Category <span style="color:red;">*</span></label>
                            <input type="text"  class="form-control" name="third_category_name" placeholder="Third Category"/>
                        </div>
                    </div>
                </div>
            </form>
