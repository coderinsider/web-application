...
<ol class="breadcrumb custombreadcrumb">
    ...
    <li class="bread-item active" aria-current="page"><a href="/admin/product-thi-category"><i class="fas fa-chevron-right"></i><h4>Third Category Lists</h4></a></li>
</ol>
@endsection
@section('content')
<div class="backend-right-main-panel">
    ...
    <div class="backend-head-box">
        <div class="nav-name-text">
            <h3>Third Category Lists</h3>
        </div>
        <div class="nav-post-add">
            <a href="{{ route('productthicategorynew') }}">Add New</a>
        </div>
    </div>
        ...
        <div class="table-box-panel">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>{{ $eachValue['sec_category_id'] }}</td>
                    <td>{{ $eachValue['third_category_name'] }}</td>
                    <td>
                        <div class="moreactions">
                            <div class="editme">
                                <button><a href="{{ route('productthicategoryedit', ['id' => $eachValue['id']])}}"><i class="fas fa-edit"></i> Edit</a></button>  
                            </div>
                            <div class="deleteme"> 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="deletenow{{$eachValue['id']}}" method="post" action="{{ route('productthicategorydelete', ['id' => $eachValue['id']])}}"></form>
                                            </div>
                                        </div>
                                    </div>
                                </div>                                  
